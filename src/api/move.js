...
export const makeChessMove = async (move, game_token) => {
  try {
    ...
    const response = await fetch("https://aiarena-games-api.duckdns.org/make_move/make_move", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export const boardReset = async (old_game_token, game_token) => {
  try {
    const response = await fetch("https://aiarena-games-api.duckdns.org/make_move/board_reset", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
